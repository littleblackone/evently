...
export default function Card({ event, hasOrderLink, hidePrice }: CardProps) {
  ...
  return (
    <div className=" relative flex min-h-[380px] w-full max-w-[400px] flex-col overflow-hidden rounded-xl bg-white shadow-md transition-all hover:shadow-lg md:min-h-[438px]">
      <Link
